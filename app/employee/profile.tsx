...
const Profile: React.FC = () => {
  ...
  return (
    <div>
      <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-4">My Profile</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4">
              <h3 className="text-md font-medium text-gray-900 dark:text-white">Personal Information</h3>
              {!isEditing ? (
                <button
            ...
            {!isEditing ? (
              <div className="space-y-3">
                <div className="flex">
                  <div className="w-24 text-sm font-medium text-gray-500 dark:text-gray-400">Name:</div>
                  <div className="flex-1 text-sm text-gray-900 dark:text-white">{user?.name}</div>
                </div>
                <div className="flex">
                  <div className="w-24 text-sm font-medium text-gray-500 dark:text-gray-400">Email:</div>
                  <div className="flex-1 text-sm text-gray-900 dark:text-white">{user?.email}</div>
                </div>
                <div className="flex">
                  <div className="w-24 text-sm font-medium text-gray-500 dark:text-gray-400">Role:</div>
                  <div className="flex-1 text-sm text-gray-900 dark:text-white capitalize">{user?.role}</div>
                </div>
                <div className="flex">
                  <div className="w-24 text-sm font-medium text-gray-500 dark:text-gray-400">ID:</div>
                  <div className="flex-1 text-sm text-gray-900 dark:text-white">{user?.id}</div>
                </div>
              </div>
            ) : (
          ...
          {/* Leave Balance */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
            <h3 className="text-md font-medium text-gray-900 dark:text-white mb-4">Leave Balance</h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {/* Paid Leave */}
              <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-3">
                <h4 className="text-sm font-medium text-blue-800 dark:text-blue-300 mb-2">Paid Leave</h4>
                <div className="flex justify-between items-center mb-1">
                  <span className="text-xs text-blue-600 dark:text-blue-400">Remaining</span>
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                  <div
                    ...
                    style={{ width: `${(leaveBalance?.paid || 0) / (leaveBalance?.maxPaid || 1) * 100}%` }}
                  ></div>
                </div>
              ...
              <div className="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-3">
                <h4 className="text-sm font-medium text-purple-800 dark:text-purple-300 mb-2">Sick Leave</h4>
                <div className="flex justify-between items-center mb-1">
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                  <div
                    ...
                    style={{ width: `${(leaveBalance?.sick || 0) / (leaveBalance?.maxSick || 1) * 100}%` }}
                  ></div>
                </div>
              ...
              <div className="bg-indigo-50 dark:bg-indigo-900/30 rounded-lg p-3">
                <h4 className="text-sm font-medium text-indigo-800 dark:text-indigo-300 mb-2">Casual Leave</h4>
                <div className="flex justify-between items-center mb-1">
                  <span className="text-xs text-indigo-600 dark:text-indigo-400">Remaining</span>
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                  <div
                    ...
                    style={{ width: `${(leaveBalance?.casual || 0) / (leaveBalance?.maxCasual || 1) * 100}%` }}
                  ></div>
                </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                <h4 className="text-sm font-medium text-gray-800 dark:text-gray-300 mb-2">Miscellaneous</h4>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-sm font-semibold text-gray-800 dark:text-gray-300">
                    {leaveBalance?.miscellaneous || 0}/{leaveBalance?.maxMiscellaneous || 0}
                  </span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                  <div
                    className="bg-gray-600 h-1.5 rounded-full"
                    style={{ width: `${(leaveBalance?.miscellaneous || 0) / (leaveBalance?.maxMiscellaneous || 1) * 100}%` }}
                  ></div>
                </div>
          ...
          {/* Leave Statistics */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
            <h3 className="text-md font-medium text-gray-900 dark:text-white mb-4">Leave Statistics</h3>

            <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-6">
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-gray-800 dark:text-gray-200">{leaveStats.totalRequested}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Total Requests</div>
              </div>
              <div className="bg-green-50 dark:bg-green-900/30 rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-green-600 dark:text-green-400">{leaveStats.approved}</div>
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/30 rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{leaveStats.pending}</div>
                <div className="text-xs text-yellow-600 dark:text-yellow-400">Pending</div>
              </div>
              <div className="bg-red-50 dark:bg-red-900/30 rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-red-600 dark:text-red-400">{leaveStats.rejected}</div>
              ...
              <div className="bg-amber-50 dark:bg-amber-900/30 rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">{leaveStats.emergency}</div>
                <div className="text-xs text-amber-600 dark:text-amber-400">Emergency</div>
              </div>
            </div>

            {/* Leave Usage Chart */}
            <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Leave Utilization</h4>
            ...
            <div className="space-y-3">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-xs text-gray-600 dark:text-gray-400">
                    {getUtilizationPercentage(
                      (leaveBalance?.maxCasual || 0) - (leaveBalance?.casual || 0),
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-xs text-gray-600 dark:text-gray-400">
                    {getUtilizationPercentage(
                      (leaveBalance?.maxMiscellaneous || 0) - (leaveBalance?.miscellaneous || 0),
          ...
          {/* Account Settings */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
            <h3 className="text-md font-medium text-gray-900 dark:text-white mb-4">Account Settings</h3>

            <div className="space-y-4">
              <div>
                <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Notification Preferences</h4>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      defaultChecked
                    />
                    <label htmlFor="reminderNotif" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      defaultChecked
                    />
                    <label htmlFor="teamNotif" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  Note: Password functionality is not implemented in this prototype
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Feedback Section */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
            <h3 className="text-md font-medium text-gray-900 dark:text-white mb-4">Feedback</h3>
